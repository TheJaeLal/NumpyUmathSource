...
static char absolute_signatures[] = {NPY_BOOL, NPY_BOOL, NPY_BYTE, NPY_BYTE, NPY_UBYTE, NPY_UBYTE, NPY_SHORT, 
				     NPY_SHORT, NPY_USHORT, NPY_USHORT, NPY_INT, NPY_INT, NPY_UINT, NPY_UINT, 
				     NPY_LONG, NPY_LONG, NPY_ULONG, NPY_ULONG, NPY_LONGLONG, NPY_LONGLONG, 
				     NPY_ULONGLONG, NPY_ULONGLONG, NPY_HALF, NPY_HALF, NPY_FLOAT, NPY_FLOAT,
				     NPY_DOUBLE, NPY_DOUBLE, NPY_LONGDOUBLE, NPY_LONGDOUBLE, NPY_TIMEDELTA,
				     NPY_TIMEDELTA, NPY_CFLOAT, NPY_FLOAT, NPY_CDOUBLE, NPY_DOUBLE,
				     NPY_CLONGDOUBLE, NPY_LONGDOUBLE, NPY_OBJECT, NPY_OBJECT};

static PyUFuncGenericFunction add_functions[] = {BOOL_add, BYTE_add, UBYTE_add, SHORT_add, USHORT_add, 
					        INT_add, UINT_add, LONG_add, ULONG_add, LONGLONG_add, ULONGLONG_add,
						HALF_add, FLOAT_add, DOUBLE_add, LONGDOUBLE_add, CFLOAT_add, CDOUBLE_add,
						 CLONGDOUBLE_add, DATETIME_Mm_M_add, TIMEDELTA_mm_m_add, DATETIME_mM_M_add, NULL};
...
static PyUFuncGenericFunction exp_functions[] = {NULL, FLOAT_exp, NULL, NULL, NULL, NULL, NULL, NULL, NULL};
static void * exp_data[] = {(void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)"exp"};
static char exp_signatures[] = {NPY_HALF, NPY_HALF, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_DOUBLE, NPY_DOUBLE, NPY_LONGDOUBLE, NPY_LONGDOUBLE, NPY_CFLOAT, NPY_CFLOAT, NPY_CDOUBLE, NPY_CDOUBLE, NPY_CLONGDOUBLE, NPY_CLONGDOUBLE, NPY_OBJECT, NPY_OBJECT};
...
InitOperators(PyObject *dictionary) {
    ...
    exp_functions[2] = PyUFunc_f_f;
    exp_data[2] = (void *) npy_expf;
    exp_functions[3] = PyUFunc_d_d;
    exp_data[3] = (void *) npy_exp;
    exp_functions[4] = PyUFunc_g_g;
    exp_data[4] = (void *) npy_expl;
    exp_functions[5] = PyUFunc_F_F;
    exp_data[5] = (void *) nc_expf;
    exp_functions[6] = PyUFunc_D_D;
    exp_data[6] = (void *) nc_exp;
    exp_functions[7] = PyUFunc_G_G;
    exp_data[7] = (void *) nc_expl;
    exp_functions[8] = PyUFunc_O_O_method;
    ...
    f = PyUFunc_FromFuncAndDataAndSignatureAndIdentity(
        divide_functions, divide_data, divide_signatures, 21,
    ...
    ((PyUFuncObject *)f)->type_resolver = &PyUFunc_MixedDivisionTypeResolver;
    ...
    f = PyUFunc_FromFuncAndDataAndSignatureAndIdentity(
        exp_functions, exp_data, exp_signatures, 9,
